...
func (cpu *CPU) RLC(value uint8) uint8 {
    leftmost_bit := value >> 7
    x := value << 1

    cpu.SetZ(value == 0)
    cpu.SetN(false)
    cpu.SetH(false)
    cpu.SetC(leftmost_bit == 0x1)

    return x | leftmost_bit
...
func (cpu *CPU) RR(value uint8) uint8 {
    ...
    cpu.SetN(false)
    cpu.SetH(false)
    cpu.SetC(value & 0x1 == 0x1)

    return result
}

func (cpu *CPU) RRC(value uint8) uint8 {
    rightmost_bit := value & 0x1
    x := value >> 1

    cpu.SetZ(value == 0)
    cpu.SetN(false)
    cpu.SetH(false)
    cpu.SetC(rightmost_bit == 0x1)

    return (rightmost_bit << 7) | x
}
...
func (cpu *CPU) ExecuteInstruction() {
    ...
    switch opcode {
        ...
        case 0x07: // RLCA
            cpu.a = cpu.RLC(cpu.a)
            cpu.SetZ(false) // Unset for this operation unlike regular RLC
        case 0x08: // LD (u16), SP
            lsb, msb := cpu.ReadMemory(), cpu.ReadMemory()
        ...
        case 0xCB: // PREFIXED COMMANDS :( 
            cpu.ExecuteInstructionCB()
...
func (cpu *CPU) ExecuteInstructionCB() {
    opcode := cpu.ReadMemory()
    ...
    switch opcode {
        ...
        case 0x06: // RLC (HL)
            memory_address := ConcatBytes(cpu.h, cpu.l)
            cpu.memory[memory_address] = cpu.RLC(cpu.memory[memory_address])
        case 0x07: // RLC A
            cpu.a = cpu.RLC(cpu.a)
        case 0x08: // RRC B
            cpu.b = cpu.RRC(cpu.a)
        ...
        case 0x0E: // RRC (HL)
            memory_address := ConcatBytes(cpu.h, cpu.l)
            cpu.memory[memory_address] = cpu.RRC(cpu.memory[memory_address])
        case 0x0F: // RRC A
            cpu.a = cpu.RRC(cpu.a)
        ...
        case 0x16: // RL (HL)
            memory_address := ConcatBytes(cpu.h, cpu.l)
            cpu.memory[memory_address] = cpu.RL(cpu.memory[memory_address])
        case 0x17: // RL A
            cpu.a = cpu.RL(cpu.a)
        case 0x18: // RR B
            cpu.b = cpu.RR(cpu.b)
        ...
        case 0x1E: // RR (HL)
            memory_address := ConcatBytes(cpu.h, cpu.l)
            cpu.memory[memory_address] = cpu.RR(cpu.memory[memory_address])
        case 0x1F: // RR A
            cpu.a = cpu.RR(cpu.a)
        ...
        case 0x26: // SLA (HL)
            memory_address := ConcatBytes(cpu.h, cpu.l)
            cpu.memory[memory_address] = cpu.SLA(cpu.memory[memory_address])
        case 0x27: // SLA A
            cpu.a = cpu.SLA(cpu.a)
        case 0x28: // SRA B
            cpu.b = cpu.SRA(cpu.b)
        ...
        case 0x2E: // SRA (HL)
            memory_address := ConcatBytes(cpu.h, cpu.l)
            cpu.memory[memory_address] = cpu.SRA(cpu.memory[memory_address])
        case 0x2F: // SRA A
            cpu.a = cpu.SRA(cpu.a)
        ...
        case 0x36: // SWAP (HL)
            memory_address := ConcatBytes(cpu.h, cpu.l)
            cpu.memory[memory_address] = cpu.Swap(cpu.memory[memory_address])
        case 0x37: // SWAP A
